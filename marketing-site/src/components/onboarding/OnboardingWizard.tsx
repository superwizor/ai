...
const MODALITY_SVG_ICONS: Record<string, (active: boolean) => ReactNode> = {
  ...
  PSYCHO: (a) => <svg className={svgClass} viewBox="0 0 24 24" fill="none" stroke={a ? "#F2F0EA" : "#8FA5A0"} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="4"/><circle cx="12" cy="12" r="1"/><path d="M12 3v2M12 19v2"/></svg>,
