...
resource: file:///Users/maciekckoklormam91/Desktop/Inne/APP%20-%20Superwizor%20AI/docs/19_WEB_APP_DESIGN.md
...
# 19. Web App — Design Spec

**Version:** 0.2 (2026-05-27) — incorporates Antigravity design-review notes
**Owner:** Dariusz + backend agent
**Related:** `01_ARCHITEKTURA_TECHNICZNA.md`, `agents/00_GLOBAL_CONTEXT.md`, `agents/01_identity-svc.md`, `09_UI_MVP_FLUTTER.md` (the design system this borrows from)
**Changelog vs v0.1:**
...
- **R8** Full CRUD spec aligned with the data model. New §13 enumerates every form (registration, profile edit, org edit, admin CRUD) field-by-field, mapped to the canonical `users` / `organizations` / `addresses` columns from `docs/02_DATA_MODEL.md`. §6.1 RPC list extended with `UpdateOrganization`, `GetMyOrganization`, `UpdateMyProfile`, `GetMyProfile`, and three admin-scoped Update/Delete RPCs.
...
└── docs/19_WEB_APP_DESIGN.md       # this doc
```
