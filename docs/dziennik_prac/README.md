...
|------|-------------|--------------|
| 2026-05-29 | [🛡️ Bezpieczeństwo A++ — Audyt, Testy, Web](2026-05-29-bezpieczenstwo-a++-audyt-testy-web.md) | Zewnętrzny audyt bezpieczeństwa, 165 testów A++, 5 quick fixów (HKDF domain separation, SecureRandom singleton, timeout, manifest timestamp, sessionId assertion), Web conditional imports. |
