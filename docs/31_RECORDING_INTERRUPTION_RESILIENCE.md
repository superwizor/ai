...
title: "31 — Recording Interruption Resilience (phone-call loss bug)"
description: "---"
resource: file:///Users/maciekckoklormam91/Desktop/Inne/APP%20-%20Superwizor%20AI/docs/31_RECORDING_INTERRUPTION_RESILIENCE.md
...
# 31 — Recording Interruption Resilience (phone-call loss bug)
...
| **Related docs** | `09_UI_MVP_FLUTTER.md` (Task 3.5 — interruption handling, never implemented), `11_IPHONE_AUDIO_CONVERSION.md`, `25/26_RESUMABLE_UPLOAD_*.md`, `22_SESSION_STATUS_PROPAGATION_AND_FAILURE_SEMANTICS.md` |
