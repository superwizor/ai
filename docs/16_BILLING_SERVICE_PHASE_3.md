...
- [02_ARCHITEKTURA_TECHNICZNA.md §4.2.2](./02_ARCHITEKTURA_TECHNICZNA.md) — high-level service responsibility.
- [03_DATA_MODEL.md §4.4](./03_DATA_MODEL.md) — base billing schema (v4.3 — zaktualizowana wartość `tokens_*` per ADR-DM-017 w v4.4).
