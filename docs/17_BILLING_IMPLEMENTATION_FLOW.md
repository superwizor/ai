...
**Related:** `16_BILLING_SERVICE_PHASE_3.md` (canonical design — note that the Firestore-mirror / outbox-poller sections of §16 are superseded; see §5 below), `agents/03_billing-svc.md` (service-level reference), `agents/00_GLOBAL_CONTEXT.md`.
