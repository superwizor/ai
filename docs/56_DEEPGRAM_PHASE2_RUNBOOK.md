---
type: Runbook
title: "56. Runbook: Deepgram STT — Faza 2 (deploy  walidacja na stagingu)"
description: "Wykonanie ręczne kroków z `docs/46_DEEPGRAM_STT_MIGRATION.md` §Faza 2"
resource: file:///Users/maciekckoklormam91/Desktop/Inne/APP - Superwizor AI/docs/56_56_DEEPGRAM_PHASE2_RUNBOOK.md
...
# 56. Runbook: Deepgram STT — Faza 2 (deploy + walidacja na stagingu)

Wykonanie ręczne kroków z `docs/46_DEEPGRAM_STT_MIGRATION.md` §Faza 2
