      ...
      children: [
        ...
        if (showButton)
          Positioned(
            ...
            bottom: 90,
            child: SafeArea(
              child: _DebugFloatingButton(ref: ref),
            ),
          ),
      ],
    );
...
class _DebugFloatingButtonState extends State<_DebugFloatingButton> with SingleTickerProviderStateMixin {
    ...
    for (final entry in sessionsMap.entries) {
      for (final session in entry.value) {
        ...
        if (session.status == SessionStatus.completed) {
          ...
          sessionDetails.add(_SessionDebugInfo(
            patientId: entry.key,
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  const Icon(Icons.bug_report, color: Colors.deepOrange, size: 20),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  _StatRow(label: 'Viewed reports', value: '${viewedReports.length}'),
                  _StatRow(label: 'Unread reports', value: '$unreadReports', highlight: unreadReports > 0),
                  _StatRow(label: 'Total sessions', value: '$totalSessions'),
                  _StatRow(label: 'Completed', value: '$completedSessions'),
                  _StatRow(label: 'Sort mode', value: sortFilter.sortMode.name),
                  _StatRow(
              ...
              child: Column(
                children: [
                  _ActionButton(
                    ...
                    subtitle: 'Każdy completed raport pokaże "Nowy raport"',
                    ...
                    onTap: () async {
                      ...
                      if (context.mounted) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('✅ Viewed reports wyczyszczone — zrób hot restart'),
                  ...
                  _ActionButton(
                    ...
                    onTap: () async {
                      final notifier = ref.read(viewedReportsProvider.notifier);
                      for (final entry in sessionsMap.entries) {
                        for (final session in entry.value) {
                          if (session.status == SessionStatus.completed) {
                      ...
                      if (context.mounted) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('✅ Wszystkie raporty oznaczone jako viewed'),
                  ...
                  _ActionButton(
                    ...
                    onTap: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('✅ Sort/filter zresetowany do domyślnych'),
                  ...
                  _ActionButton(
                    ...
                    onTap: () async {
                      ...
                      if (context.mounted) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('💣 SharedPreferences wyczyszczony — hot restart!'),
                ...
                children: [
                  ...
                  Builder(
                    builder: (ctx) {
                      ...
                      final existingSessions = sessionsMap[firstPatient.id] ?? [];
                      ...
                      return Column(
                        children: [
                              ...
                              children: [
                                ...
                                if (debugSession != null)
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: _colorForStatus(debugSession.status)
                          ...
                          _ActionButton(
                            ...
                            subtitle: 'Wrzuca sesję inProgress → kafelek "AI analizuje"',
                            ...
                            onTap: () {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text('🔄 Fake "AI analizuje" injected'),
                          ...
                          _ActionButton(
                            ...
                            subtitle: 'Wrzuca sesję pendingUpload → "Wgrywanie pliku"',
                            ...
                            onTap: () {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text('☁️ Fake "pendingUpload" injected'),
                          ...
                          _ActionButton(
                            ...
                            subtitle: 'Wrzuca sesję error → kafelek "Błąd analizy"',
                            color: Colors.redAccent,
                            onTap: () {
                              ref.read(sessionsProvider.notifier)
                                  .debugInjectSession(
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text('❌ Fake "error" injected'),
                          ...
                          _ActionButton(
                            ...
                            label: 'Symuluj: inProgress → completed (10s)',
                            subtitle: 'Injektuje inProgress, po 10s → completed → 🎉',
                            ...
                            onTap: () {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text('⏳ inProgress → za 10s completed...'),
                          ...
                          if (debugSession != null)
                            _ActionButton(
                              ...
                              subtitle: 'Czyści fake session z widoku',
                              color: Colors.grey,
                              onTap: () {
                                ref.read(sessionsProvider.notifier)
                                    .debugRemoveSession(
                                        firstPatient.id, debugSessionId);
                                Navigator.pop(context);
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                    content: Text('🗑 Debug session usunięta'),
                ...
                children: [
                  ...
                  Builder(
                    builder: (ctx) {
                      ...
                      final therapistId = user?.id ?? 'debug-therapist';
                      ...
                      return Column(
                        children: [
                          _ActionButton(
                            ...
                            subtitle: 'Fake upload z animowanym progress barem 0→100%',
                            ...
                            onTap: () async {
                              ...
                              final fakeUpload = PendingUpload(
                                ...
                                phase: UploadPhase.created, // uploading phase
                                idempotencyKey: localId,
                                queuedAt: DateTime.now().toUtc(),
                                nextAttemptAt: DateTime.now().toUtc().add(
                                    const Duration(hours: 24)), // never due
                                uploadProgress: 0.0,
                              );
                              ...
                              Timer.periodic(
                                ...
                                (timer) {
                                  ...
                                  runner.debugSetProgress(localId, fraction);
                                },
                              );
                          ...
                          _ActionButton(
                            ...
                            subtitle: 'Fake upload z phase=failed i błędem',
                            color: Colors.red,
                            onTap: () async {
                              ...
                              final fakeUpload = PendingUpload(
                                ...
                                lastError: 'debug.simulated_network_error',
                          ...
                          _ActionButton(
                            ...
                            subtitle: 'Fake upload z phase=quotaBlocked',
                            color: Colors.amber,
                            onTap: () async {
                          ...
                          _ActionButton(
                            ...
                            subtitle: 'Upload rośnie do 50%, potem fail (network_timeout)',
                            color: Colors.deepOrange,
                            onTap: () async {
                              const localId = 'debug-upload-interrupted';
                              final runner = await ref.read(uploadQueueRunnerProvider.future);
                              if (runner == null) return;
                              ...
                              final fakeUpload = PendingUpload(
                                ...
                                patientLanguageCode: 'pl-PL',
                                sourceKind: UploadSourceKind.plainFile,
                                sourcePath: '/debug/fake-interrupted.flac',
                                contentType: 'audio/flac',
                              ...
                              Timer.periodic(
                                ...
                                (timer) {
                                  step++;
                                  final fraction = (step / totalSteps) * 0.5;
                                  if (step >= totalSteps) {
                                    timer.cancel();
                                    // Flip to failed state
                                    runner.debugInjectRow(PendingUpload(
                                      localId: localId,
                                      therapistId: therapistId,
                                      patientFileId: firstPatient.id,
                                      patientLanguageCode: 'pl-PL',
                                      ...
                                      nextAttemptAt: DateTime.now().toUtc(),
                                      uploadProgress: 0.5,
                                      lastError: 'network_timeout: connection lost at 50%',
                                      terminatedAt: DateTime.now().toUtc(),
                                    ));
                                    debugPrint(
                          ...
                          _ActionButton(
                            ...
                            subtitle: 'Testuje kolejkę z wieloma plikami jednocześnie',
                            ...
                            onTap: () async {
                              ...
                              final configs = <(String localId, String patientId, int sizeBytes, int durationSec, int animMs)>[
                                ('debug-multi-1', patients[0].id, 52428800, 1800, 400),
                                ('debug-multi-2', patients.length > 1 ? patients[1].id : patients[0].id, 31457280, 900, 600),
                                ('debug-multi-3', patients.length > 2 ? patients[2].id : patients[0].id, 83886080, 2400, 300),
                              ];

                              for (final (localId, patientId, sizeBytes, dur, _) in configs) {
                                runner.debugInjectRow(PendingUpload(
                                  localId: localId,
                                  therapistId: therapistId,
                              ...
                              for (final (localId, _, _, _, animMs) in configs) {
                                int step = 0;
                                const totalSteps = 50;
                                Timer.periodic(
                          ...
                          _ActionButton(
                            ...
                            subtitle: 'Usuń wszystkie fake uploady z pamięci',
                            color: Colors.grey,
                            onTap: () async {
                              final runner = await ref.read(uploadQueueRunnerProvider.future);
                              if (runner == null) return;
                              ...
                              if (context.mounted) {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                    content: Text('🧹 Debug uploads wyczyszczone'),
                                    backgroundColor: Colors.grey,
                                  ),
                                );
                              }
              ...
              child: Column(
                ...
                children: [
                  ...
                  _ActionButton(
                    ...
                    subtitle: 'pending → uploaded → analyzing → done (16s total)',
                    color: Colors.greenAccent,
                    onTap: () {
                      Navigator.pop(context);
                      Navigator.of(context).push(MaterialPageRoute(
                        builder: (_) => const DebugPipelineSimulatorScreen(
                          autoAdvance: true,
                  ...
                  _ActionButton(
                    ...
                    subtitle: 'pending → uploaded → analyzing → FAILED (16s)',
                    color: Colors.redAccent,
                    onTap: () {
                      Navigator.pop(context);
                      Navigator.of(context).push(MaterialPageRoute(
                  ...
                  _ActionButton(
                    ...
                    subtitle: 'Ręcznie klikaj → next step, testuj każdy stan',
                    color: Colors.tealAccent,
                    onTap: () {
                      Navigator.pop(context);
                      Navigator.of(context).push(MaterialPageRoute(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Padding(
                      ...
                      child: Row(
                        children: [
                          Icon(
                            info.isViewed ? Icons.check_circle : Icons.new_releases,
                            size: 14,
                            color: info.isViewed ? Colors.green : Colors.amber,
                          ),
                          const SizedBox(width: 8),
                          Expanded(
                            child: Text(
                          ...
                          GestureDetector(
                            onTap: () {
                              ...
                              ref.read(viewedReportsProvider.notifier)
